...
const AddEditCarDetails = ({ title, existingDetails, isShowPopup, closePopup, getCarDetails }: Props) => {
    ...
    const [loanInfo, setLoanInfo] = useState<LoanInfoType>({
        ...
        friendlyLoan1: existingDetails?.loanInfo.friendlyLoan1 || "",
        friendlyLoan1Description: existingDetails?.loanInfo.friendlyLoan1Description || "",
        friendlyLoan2: existingDetails?.loanInfo.friendlyLoan2 || "",
        friendlyLoan2Description: existingDetails?.loanInfo.friendlyLoan2Description || "",
        loandisbursementDescription: existingDetails?.loanInfo.loandisbursementDescription || "",
    ...
    const [loanInfoChangesStatus, setLoanInfoChangesStatus] = useState<LoanInfoChangesStatusType>({
        ...
        friendlyLoan1: false,
        friendlyLoan1Description: false,
        friendlyLoan2: false,
        friendlyLoan2Description: false,
        loandisbursementDescription: false,
        downPayment: false,
        interestRate: false,
    })
    ...
    const clearState = () => {
        ...
        setLoanInfo({
            ...
            additionalCharges: "",
            friendlyLoan1: "",
            friendlyLoan1Description: "",
            friendlyLoan2: "",
            friendlyLoan2Description: "",
            loandisbursementDescription: "",
            downPayment: "",
            interestRate: "",
        })
        setCustomerInfo({
